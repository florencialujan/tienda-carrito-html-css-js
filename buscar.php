...
if(isset($_POST['agregar_al_carrito'])){
    ...
    if(mysqli_num_rows($comprobar_carrito) > 0){
        ...
        mysqli_query($conn, "INSERT INTO `cart`(user_id, pid, pnombre, pprecio, pcantidad, pimagen) VALUES('$user_id', '$id_producto', '$nombre_producto', '$precio_producto', '$cantidad_producto', '$imagen_producto')") or die('falló la query');
...
<section class="search-form">
    <form action="" method="POST">
        ...
        <input type="submit" class="btn" value="search" name="buscar_btn">
    </form>
</section>
